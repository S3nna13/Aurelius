...
_LAZY_INTERFACE_EXPORTS = {
    ...
    "FileMemoryStore": (".file_memory_store", "FileMemoryStore"),
...
# --- provider chain with fallback (additive) ---------------------------------
from .auxiliary_client import (  # noqa: E402
    AuxiliaryClient,
    AuxiliaryConfig,
)
from .provider_chain import (  # noqa: E402
    PROVIDER_CHAIN_REGISTRY,
    ChainConfig,
    ChainResult,
    ProviderChain,
    ProviderStats,
...
AGENT_LOOP_REGISTRY["provider_chain"] = ProviderChain
...
# --- persistent agent wrapper (additive) --------------------------------------
from .persistent_agent import PersistentAgent  # noqa: E402
...
AGENT_LOOP_REGISTRY["persistent"] = PersistentAgent
