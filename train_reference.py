...
def train(model, train_loader, val_loader, device, total_steps=1000, warmup=100,
    ...
    report = {
        ...
        "val_loss": avg_val, "val_perplexity": math.exp(avg_val), "history": history,
    }
...
def main():
    ...
    train_ds = ShardDataset(["data/pretrain/reference/train_shard_000.npy"], CONFIG.max_seq_len, stride=128)
    val_ds = ShardDataset(["data/pretrain/reference/val_shard_000.npy"], CONFIG.max_seq_len, stride=128)
