...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--react",
        action="store_true",
        help="Enable the ReAct/agentic tool-use loop for local model chat.",
    )
    parser.add_argument(
        "--max-tokens",
        type=int,
        ...
        try:
            ...
            if args.react:
                ...
                generate_fn = build_agentic_prompt_generate_fn(
                    ...
                    agent_config=AgentConfig(max_new_tokens_per_step=args.max_tokens),
                )
            else:
                generate_fn = build_prompt_generate_fn(
                    model,
                    tokenizer,
