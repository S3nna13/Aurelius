...
from .engine_loader import build_engine  # noqa: E402,F401
...
# --- vLLM engine (paged attention) ----------------------------------------
from .vllm_engine import VLLMEngine  # noqa: E402,F401

_module = sys.modules[__name__]
sys.modules["src.serving"] = _module
sys.modules["aurelius.serving"] = _module
sys.modules["serving"] = _module
...
_mirror_namespace("src.serving", "aurelius.serving")
_mirror_namespace("aurelius.serving", "src.serving")
_mirror_namespace("src.serving", "serving")
_mirror_namespace("aurelius.serving", "serving")
