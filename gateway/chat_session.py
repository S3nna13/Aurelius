...
def load_model_for_chat(
    ...
    Note:
        Tokenizer loading falls back to a byte-level tokenizer when no saved
        tokenizer artifact is available.
    """
    ...
    from .agentic_runtime import load_tokenizer_for_chat
    ...
    tokenizer = load_tokenizer_for_chat(checkpoint_dir)
