...
class FineWeb2Dataset(IterableDataset):
    ...
    def __init__(self, tokenizer, seq_len: int = 4096,
                 split: str = "train", use_hq: bool = True,
    ...
    def _stream_fineweb2(self) -> Iterator[str]:
        ...
        for lang in self.languages:
            ds = load_dataset("HuggingFaceFW/fineweb-2", name=f"CC-MAIN-2024-10_{lang}",  # nosec B615
