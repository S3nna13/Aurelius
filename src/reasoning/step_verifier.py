...
class StepVerifier:
    ...
    def __init__(
        self, min_step_length: int = 5, contradiction_keywords: list[str] | None = None
    ) -> None:
    ...
    def verify_step(self, step_index: int, content: str, context: str = "") -> StepScore:
    ...
    def verify_chain(self, steps: list[str], context: str = "") -> list[StepScore]:
