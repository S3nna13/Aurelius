...
from src.mcp.skill_catalog import SkillCatalog, SkillCatalogError, SkillMetadata
...
DEFAULT_TRIGGER_ENGINE: SkillTriggerEngine = SkillTriggerEngine(SkillCatalog())
