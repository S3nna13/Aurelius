...
class WeightedConsensus:
    ...
    def vote(self, votes: list[Vote[T]]) -> ConsensusResult[T]:
        ...
        quorum_met = (total_votes >= self.quorum_threshold and 
                   len(weighted_counts) == 1) or total_votes >= 1.0
        ...
        runoff = (
            len(choices) >= self.min_choices_for_runoff and
            top_weight < self.quorum_threshold and
            total_votes >= 0.5
        )
