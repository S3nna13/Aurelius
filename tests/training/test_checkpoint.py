...
def test_save_meta_content(tmp_path, small_model):
    ...
    save_checkpoint(
        small_model, None, step=42, epoch=2, train_loss=1.23, output_dir=tmp_path, val_loss=1.10
    )
...
def test_load_restores_weights(tmp_path, small_model):
    ...
    ckpt_dir = save_checkpoint(
        small_model, None, step=1, epoch=0, train_loss=1.0, output_dir=tmp_path
    )
...
def test_best_checkpoint_tracking(tmp_path, small_model):
    ...
    save_checkpoint(
        small_model, None, step=10, epoch=0, train_loss=2.0, output_dir=tmp_path, val_loss=2.0
    )
    save_checkpoint(
        small_model, None, step=20, epoch=0, train_loss=1.5, output_dir=tmp_path, val_loss=1.5
    )
    save_checkpoint(
        small_model, None, step=30, epoch=0, train_loss=1.8, output_dir=tmp_path, val_loss=1.8
    )
...
def test_load_best_checkpoint(tmp_path, small_model):
    ...
    save_checkpoint(
        small_model, None, step=5, epoch=0, train_loss=3.0, output_dir=tmp_path, val_loss=3.0
    )
