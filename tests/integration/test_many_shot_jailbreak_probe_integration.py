...
def test_many_shot_jailbreak_probe_registered():
    ...
    assert METRIC_REGISTRY["many_shot_jailbreak_probe"] is ManyShotJailbreakProbe
    assert BENCHMARK_REGISTRY["many_shot_jailbreak_probe"] is ManyShotJailbreakProbe
