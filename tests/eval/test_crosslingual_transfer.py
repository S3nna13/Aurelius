...
def test_compute_transfer_gap(evaluator):
    src = LanguageResult(
        "en", accuracy=0.8, n_samples=10, avg_confidence=0.7, language_confusion_rate=0.0
    )
    tgt = LanguageResult(
        "fr", accuracy=0.6, n_samples=10, avg_confidence=0.6, language_confusion_rate=0.0
    )
